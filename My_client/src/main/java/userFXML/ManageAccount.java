...
public class ManageAccount implements Initializable {
    ...
    public void OnAdd() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("adminFXML/AddClient.fxml"));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
    ...
    public void OnEdit() throws IOException {
        ...
        if(clientModel == null){
            ...
            Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("adminFXML/UpdateClient.fxml"));
            Scene newScene = new Scene(root);
            stage.setScene(newScene);
        }
    }
